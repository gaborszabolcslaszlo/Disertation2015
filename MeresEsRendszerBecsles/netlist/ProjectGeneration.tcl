#
# Created by System Generator     Wed Feb 25 01:20:35 2015
#
...
namespace eval ::xilinx::dsptool::iseproject::param {
    ...
    set ProjectFiles {
        {{meromodul_cw.vhd} -view All}
        {{meromodul.vhd} -view All}
        {{meromodul_cw.ucf}}
        {{meromodul_cw.xdc}}
        {{C:\Users\laca\Desktop\iRoobo2014Ver3\Fpga\SPARTAN3E\Spartan3E6500SystemVer2\MeresEsRendszerBecsles\MeroModul.slx}}
    }
    set TopLevelModule {meromodul_cw}
    set SynthesisConstraintsFile {meromodul_cw.xcf}
