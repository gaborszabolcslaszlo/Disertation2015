#
# Created by System Generator     Thu Feb 19 20:44:39 2015
#
...
namespace eval ::xilinx::dsptool::iseproject::param {
    ...
    set ProjectFiles {
        {{motorpoz_cw.vhd} -view All}
        {{motorpoz.vhd} -view All}
        {{motorpoz_cw.ucf}}
        {{motorpoz_cw.xdc}}
        {{C:\Users\laca\Desktop\iRoobo2014Ver3\Fpga\SPARTAN3E\Spartan3E6500SystemVer2\dcMOTORpositionPID\MotorPoz.slx}}
    }
    set TopLevelModule {motorpoz_cw}
    set SynthesisConstraintsFile {motorpoz_cw.xcf}
