...
$ENV{'SYSGEN'} = 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => 'E:/Allamvizsga/Spartan3E6500SystemVer2/ONOFF/netlist/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => 'E:/Allamvizsga/Spartan3E6500SystemVer2/ONOFF/netlist/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 0.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 2088.0006103515625,
    'generating_subsystem_handle' => 2088.0006103515625,
    ...
    'isdeployed' => 0,
    'ise_version' => '14.6i',
    'master_sysgen_token_handle' => 2713.0008544921875,
    'matlab' => 'C:/Program Files/MATLAB/R2012a',
    'matlab_fixedpoint' => 0.0,
    'mdlHandle' => 2088.0006103515625,
...
fprintf(\'\',\'COMMENT: end icon text\');',
    'sg_version' => '',
    'sggui_pos' => '-1,-1,-1,-1',
    'simulation_island_subsystem_handle' => 2088.0006103515625,
...
fprintf(\'\',\'COMMENT: end icon text\');',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'de6e6c3553100ab93db2e2633a2adb63',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'CSET component_name = addsb_11_0_80bded47015320ce',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '726d3f0bab243a06e4df7983b31990a4',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '9f1b2fa0bf653c2c96d6b8b46be30450',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(17 - 1 downto 0);
    s: out std_logic_vector(c_output_width - 1 downto 0);
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '962b20f49b1c818d4bc44048412ac818',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'bitbasher_b142b1358a',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '17b6ba579c407e06b573cb32243c0181',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '0f694d3790c2763eab8a3d709df96d5f',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'CSET component_name = mult_11_2_b9a510f8f49a69d2',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'bdaa6a846563a07409a3c03fd697606b',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '20b4ceadc31f4a11f007a12a13f7b32b',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'mux_65a0e0a5b3',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '6c3e931cc4b6e78c10bc8400b452bcbc',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'mux_a161f3a75c',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '876bf245df49ffba9011c50953739391',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c8760ad859386e7bb0d8f564eb34432d',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_5568c80e3e',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '707157a1dd9bc97e9dda3118cbf0651e',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_1_31: signed((17 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_5ef1f4e573',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '5e4380a11b84a60c0796edfa96c92771',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_1_31: signed((17 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_5153393142',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '870b65e7c344372d6ab97c786e507a5a',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_95270e073f',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'cbca84e6ffaa06f92965aa876faf941f',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_58b5743dd8',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c4233db32352517048bb01a3b1f0fd36',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_f2a2d93eac',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd3fb940fe16a57ebacae3d0ab5c59b9b',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_7044437b9b',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '15c7f6f0072fc32c19c28faaf4950220',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_017d9de1ab',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
    ...
    'CSET component_name = cntr_11_0_e7c6fab986d296a4',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c6074ff82bf7ddb2316c2bddb2e6e801',
    ...
    'templateKeyValues' => {
      ...
      'entityName' => 'xlcounter_free_onOff',
...
begin
  ...
  $instrs = [
    ...
    'CSET Sync_CE_Priority = Sync_Overrides_CE',
    'CSET Sync_Ctrl_Priority = Reset_Overrides_Set',
    'CSET component_name = addsb_11_0_d2b0e63c2ff9bf9d',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'cf7388abb8c0a3cd51c832622e02f16c',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(17 - 1 downto 0);
    s: out std_logic_vector(c_output_width - 1 downto 0);
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '4232158286ba4704d14777fdd1c4d14f',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(17 - 1 downto 0);
    s: out std_logic_vector(c_output_width - 1 downto 0);
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ffbdc075b136b9a6e28b2cdf744903a4',
    'sourceFile' => 'hdl/xladdsub.vhd',
    'templateKeyValues' => {
      'core_component_def' => '    a: in std_logic_vector(17 - 1 downto 0);
    s: out std_logic_vector(c_output_width - 1 downto 0);
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd9d1e4a11da9d84e88d78a2c56e6f220',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_31026a6611',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c371bca0576e31e8f3c625c7d18b55b3',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'constant_515f6b5526',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'CSET sync_threshold_output = false',
    'CSET syncctrlpriority = Reset_Overrides_Set',
    'CSET component_name = cntr_11_0_74252206ec4646ae',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '7eab898f003ee565bde0b6e63eef3da8',
    'sourceFile' => 'hdl/xlcounter_free.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '6ff7a261fb7280e9ef021951077d8c4a',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'CSET userounding = false',
    'CSET zerodetect = false',
    'CSET component_name = mult_11_2_b39611ba5425a680',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '63b7fb5b153bd23e7733d97452eda19e',
    'sourceFile' => 'hdl/xlmult.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      b: in std_logic_vector(c_b_width - 1 downto 0);
      p: out std_logic_vector(c_output_width - 1 downto 0);
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '0d97b756136a8f3fc8d2c292c4d7098f',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'fbc25ae674e6a0fa8c7b7ed46f42e588',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '3796d9d9979503d395a87a7a57e76f3d',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_1_31: unsigned((24 - 1) downto 0);
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'relational_adf9a370cd',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '6b1fb8b8ba5cfe3ed9096a444513c896',
    'sourceFile' => 'E:/Allamvizsga/Spartan3E6500SystemVer2/ONOFF/top_level.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'e8f5ede3f0e0c88d2ad4ed735bc3e913',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '5ea09d648a1c099adcad846015c81762',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '462054ac63c58bf49bbc8eb4986412d1',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'de453aca3a6247b84bae612673eb90e1',
    'sourceFile' => 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/14.6/ISE_DS/ISE/sysgen';
  open(RESULTS, '> E:/Allamvizsga/Spartan3E6500SystemVer2/ONOFF/netlist/sysgen/script_results7825690468505072832') || 
    croak 'couldn\'t open E:/Allamvizsga/Spartan3E6500SystemVer2/ONOFF/netlist/sysgen/script_results7825690468505072832';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing E:/Allamvizsga/Spartan3E6500SystemVer2/ONOFF/netlist/sysgen/script_results7825690468505072832';
};
