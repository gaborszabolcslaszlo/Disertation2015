%
% Filename:    sparten3e500kpq208c4_libgen.m
%
...
function sparten3e500kpq208c4_libgen()

disp('Loading the ''xbsTypes_r4'' library...');
load_system('xbsTypes_r4');

lib = ['sparten3e500kpq208c4_lib'];
...
name = 'Pmod1';
width = 8;
locs = '{''P160'',''P152'',''P150'',''P146'',''P153'',''P151'',''P147'',''P145''}';
ss = add_input(lib, name, width, locs);
set_param(ss, 'Position', [20 70 100 100]);

name = 'Pmod2';
width = 8;
locs = '{''P140'',''P139'',''P137'',''P134'',''P144'',''P138'',''P135'',''P133''}';
ss = add_output(lib, name, width, locs);
