...
function SensorIncModul_config(this_block)

  % Revision History:
  %
  %   04-Mar-2015  (22:51 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     C:\Users\laca\Desktop\Spartan3E6500SystemVer2\SebessegEsPozicio\SensorIncModul.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('SensorIncModul');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('SensorIncModul.vhd');
