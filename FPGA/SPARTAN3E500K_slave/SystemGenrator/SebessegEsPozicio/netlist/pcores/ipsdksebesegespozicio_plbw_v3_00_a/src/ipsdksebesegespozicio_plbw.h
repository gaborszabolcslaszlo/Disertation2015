...
typedef struct {
    ...
    uint32_t SzurtSebessegPozicio;
    uint32_t SzurtSebessegPozicio_n_bits;
    uint32_t SzurtSebessegPozicio_bin_pt;
    // uint32_t SzurtSebessegPozicio_attr;
    uint32_t AktSebesseg;
    uint32_t AktSebesseg_n_bits;
    uint32_t AktSebesseg_bin_pt;
    // uint32_t AktSebesseg_attr;
    uint32_t SzurtSebesseg;
    uint32_t SzurtSebesseg_n_bits;
    uint32_t SzurtSebesseg_bin_pt;
    // uint32_t SzurtSebesseg_attr;
    uint32_t Config;
