%
% Filename:    sparten3e500kpq208c4ip3motrokmere_libgen.m
%
...
function sparten3e500kpq208c4ip3motrokmere_libgen()

disp('Loading the ''xbsTypes_r4'' library...');
load_system('xbsTypes_r4');

lib = ['sparten3e500kpq208c4ip3motrokmere_lib'];
