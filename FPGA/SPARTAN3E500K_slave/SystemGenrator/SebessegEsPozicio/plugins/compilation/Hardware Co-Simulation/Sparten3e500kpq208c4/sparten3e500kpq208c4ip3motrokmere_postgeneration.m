%
% Filename:    sparten3e500kpq208c4ip3motrokmere_postgeneration.m
%
...
function st = sparten3e500kpq208c4ip3motrokmere_postgeneration(params)
  ...
  params.('ucf_template') = 'sparten3e500kpq208c4ip3motrokmere.ucf'; 

  % Define non-memory mapped ports.
  non_mm_ports.('LED') = {'out', 4};
  non_mm_ports.('Rst') = {'in', 1};
  non_mm_ports.('sebsensor') = {'in', 2};
  non_mm_ports.('PosistionSens') = {'in', 2};
  non_mm_ports.('PWMseb') = {'out', 2};
  non_mm_ports.('PWMpos') = {'out', 2};
  ...
  % params.('vendor_toplevel') = 'sparten3e500kpq208c4ip3motrokmere_toplevel';
  ...
  % params.('vendor_netlists') = {'sparten3e500kpq208c4ip3motrokmere_toplevel.ngc','sparten3e500kpq208c4ip3motrokmere.edf'};
