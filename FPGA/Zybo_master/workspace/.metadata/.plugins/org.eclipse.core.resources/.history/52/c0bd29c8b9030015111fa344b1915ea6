...
#define IIC_GYRO2 XPAR_IIC_1_BASEADDR
...
#define maxSizeBufferGiro 20000
int pointerToGYROTCPBuff=0;
int pointerToGYROTCPBuff1=0;
csomgOut GYROTCPBuf[maxSizeBufferGiro];
csomgOut1 GYROTCPBuf1[maxSizeBufferGiro];
...
void TsTimerCounterHandler(void *CallBackRef, u8 TmrCtrNumber)
{
	...
	//	u32 count=XUartNs550_Send(&UartNs550InstanceGPS, SendBufferGPSUart, TEST_BUFFER_SIZE);
		...
		if(maxSizeBufferGiro>pointerToGYROTCPBuff+3)
						{
						GYROTCPBuf[pointerToGYROTCPBuff].gi1=v;
						GYROTCPBuf[pointerToGYROTCPBuff].gi2=v1;
		...
		if(maxSizeBufferGiro>pointerToGYROTCPBuff1+3)
							{

							GYROTCPBuf1[pointerToGYROTCPBuff1].Poz0=recv.AktPozicio0;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Poz1=recv.AktPozicio1;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Poz2=recv.AktPozicio2;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Poz3=recv.AktPozicio3;

							GYROTCPBuf1[pointerToGYROTCPBuff1].Speed0=recv.AktSebesseg0;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Speed1=recv.AktSebesseg1;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Speed2=recv.AktSebesseg2;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Speed3=recv.AktSebesseg3;

							GYROTCPBuf1[pointerToGYROTCPBuff1].Upoz0=recv.UPozicio0;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Upoz1=recv.UPozicio1;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Upoz2=recv.UPozicio2;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Upoz3=recv.UPozicio3;

							GYROTCPBuf1[pointerToGYROTCPBuff1].Uspeed0=recv.USebesseg0;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Uspeed1=recv.USebesseg1;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Uspeed2=recv.USebesseg2;
							GYROTCPBuf1[pointerToGYROTCPBuff1].Uspeed3=recv.USebesseg3;


GYROTCPBuf1[pointerToGYROTCPBuff1].refpoz0=send.RefPos0;
GYROTCPBuf1[pointerToGYROTCPBuff1].refseb0=send.RefSeb0;

GYROTCPBuf1[pointerToGYROTCPBuff1].refpoz1=send.RefPos1;
GYROTCPBuf1[pointerToGYROTCPBuff1].refseb1=send.RefSeb1;

GYROTCPBuf1[pointerToGYROTCPBuff1].refpoz2=send.RefPos2;
GYROTCPBuf1[pointerToGYROTCPBuff1].refseb2=send.RefSeb2;

GYROTCPBuf1[pointerToGYROTCPBuff1].refpoz3=send.RefPos3;
GYROTCPBuf1[pointerToGYROTCPBuff1].refseb3=send.RefSeb3;


							++pointerToGYROTCPBuff1;
							}
							else
							{
								pointerToGYROTCPBuff1=0;
							}


			//xil_printf("Kuld SPI 01 \r\n");
			int i=0;
			//XSpi_Transfer(&SpiInstance,&send, &recv ,4);
			//s32 *ptr=&recv;
			//for(i=0;i<13;++i)
			//{
			XSpi_Transfer(&SpiInstance,&send,&recv ,(u16)sizeof(recv));
			//ptr +=4;
			//}
		...
		/*	XSpi_Transfer(&SpiInstance,ReadBufferSPIspartan, &m.USebesseg, 4);
			...
			xil_printf("-------"); */
		xil_printf("Aktf %d,%d,%d,%d,%d,%d,%d,%d\r\n",(s16)recv.AktPozicio0,(s16)(recv.AktPozicio1),(s16)recv.AktPozicio2,(s16)recv.AktPozicio3,(s16)recv.SzurtSebesseg0,(s32)recv.USebesseg0,(s16)recv.AktSebesseg0,(s16)recv.eSebeseg0);
...
/********************************Gyro****************************************/
int GyroSensorInit6050()
{
	 //FIFO
	 bufs[0]=MPU6050_RA_FIFO_EN  ;
	 XIic_Send(IIC_GYRO2, 0x68, &bufs[0], 1, XIIC_STOP); //csak ciomet kuldok
	 XIic_Recv(IIC_GYRO2, 0x68, &rbuff[0], 1, XIIC_STOP); // visszaolvasuk a FIFO EN erteket
	 bufs[0]=MPU6050_RA_FIFO_EN  ;
	 bufs[0]=rbuff[0]&0x7; //Disable All fifo
	 XIic_Send(IIC_GYRO2, 0x68, &bufs[0], 1, XIIC_STOP);
	 //Scale
	 //Accel MPU6050_RA_ACCEL_CONFIG
	 bufs[0]=MPU6050_RA_ACCEL_CONFIG   ;
	 XIic_Send(IIC_GYRO2, 0x68, &bufs[0], 1, XIIC_STOP); //csak ciomet kuldok
	 XIic_Recv(IIC_GYRO2, 0x68, &rbuff[0], 1, XIIC_STOP); // visszaolvasuk a ACCEL Config erteket
	 bufs[0]=MPU6050_RA_ACCEL_CONFIG  ;
     bufs[0]=rbuff[0]&0xE7;
     XIic_Send(IIC_GYRO2, 0x68, &bufs[0], 1, XIIC_STOP);
     //Accel MPU6050_RA_ACCEL_CONFIG
	 ...
	 bufs[1]=0x00;
	 XIic_Send(IIC_GYRO2, 0x68, &bufs[0], 2, XIIC_STOP); //csak ciomet kuldok
	 MPU9150_setupCompass();
	 return 0;
}
int GyroSensorInit9150()
{
	 //FIFO
	 bufs[0]=MPU6050_RA_FIFO_EN  ;
...
{
				buff[0] = MPU6050_RA_ACCEL_XOUT_H;
				XIic_Send(IIC_GYRO2, 0x68,&buff[0], 1, XIIC_STOP); //csak ciomet kuldok
				XIic_Recv(IIC_GYRO2, 0x68,&rbuff[0], 14, XIIC_STOP);
...
err_t recv_callback7(void *arg, struct tcp_pcb *tpcb,struct pbuf *p, err_t err)
{
	...
	if (pointerToGYROTCPBuff > 0) {
		...
		//enaSendGyro= 1;
		err = tcp_write(tpcb, GYROTCPBuf, (pointerToGYROTCPBuff)*40, 1);
	pointerToGYROTCPBuff=0;
   ...
   /* s16 *ez;
    ez=p->payload;
            ...
            send.TsH0=ez[7];
            send.TsL0=ez[8];
            send.PwmFrekREgH0=ez[9];
            send.PwmFrekRegL0=ez[10];
            send.qSav0=ez[11];
            send.sugarakAranya0=ez[12];

	xil_printf("TCP %d %d %d %d %d %d %d %d %d %d %d %d %d \n\r",ez[0],ez[1],ez[2],(s16)ez[3],(s16)ez[4],(s16)ez[5],ez[6],ez[7],(u16)ez[8],(u16)ez[9],(s16)ez[10],ez[11],ez[12]);*/
	/*s16 *ez;
	ez=p->payload;
	send.Config0=ez[0];
	send.Egyeb0=ez[6];
...
err_t recv_callback8(void *arg, struct tcp_pcb *tpcb,struct pbuf *p, err_t err)
{
	/* do not read the packet if we are not in ESTABLISHED state */
	if (!p) {
		tcp_close(tpcb);
	...
	/* echo back the payload */
	/* in this case, we assume that the payload is < TCP_SND_BUF */
	if (pointerToGYROTCPBuff1 > 0) {
		//err = tcp_write(tpcb, p->payload, p->len, 1);
		//enaSendGyro= 1;
		err = tcp_write(tpcb, GYROTCPBuf1, (pointerToGYROTCPBuff1)*sizeof(csomgOut1), 1);
	pointerToGYROTCPBuff1=0;
	//if (tcp_sndbuf(tpcb) > p->len) {
		//err = tcp_write(tpcb, p->payload, p->len, 1);
	  // err = tcp_write(tpcb, "laca", 5, 1);
...
err_t accept_callback8(void *arg, struct tcp_pcb *newpcb, err_t err)
{
	static int connection = 1;

	/* set the receive callback for this connection */
	tcp_recv(newpcb, recv_callback8);
...
int start_application8(){
	...
	/* specify callback to use for incoming connections */
	tcp_accept(pcb, accept_callback8);

	xil_printf("TCP echo server started @ port %d\n\r", port);

	return 0;
}
err_t recv_callback9(void *arg, struct tcp_pcb *tpcb,struct pbuf *p, err_t err)
{
	/* do not read the packet if we are not in ESTABLISHED state */
	if (!p) {
		tcp_close(tpcb);
...
//	pointerToGYROTCPBuff=0;
	...
	s32 sarany=ez[8];
	s32 qsav=ez[9];
	send.addresReg=ez[10];
	send.dataReg=ez[11];
	switch(ipMagId)
	{
	case 1: send.Config0=config; send.RefSeb0=speedref; send.RefPos0=posref;
	        send.Q0_0=Q0; send.Q1_0=Q1; send.Q2_0=Q2; send.Ts0=Ts; send.sugarakAranya0=sarany; send.qSav0=qsav;
	break;
	case 2: send.Config1=config; send.RefSeb1=speedref; send.RefPos1=posref;
			send.Q0_1=Q1; send.Q1_1=Q1; send.Q2_1=Q2; send.Ts1=Ts; send.sugarakAranya1=sarany; send.qSav1=qsav;
	break;
	case 3: send.Config2=config; send.RefSeb2=speedref; send.RefPos2=posref;
			send.Q0_2=Q0; send.Q1_2=Q1; send.Q2_2=Q2; send.Ts2=Ts; send.sugarakAranya2=sarany; send.qSav2=qsav;
	break;
	case 4: send.Config3=config; send.RefSeb3=speedref; send.RefPos3=posref;
			send.Q0_3=Q0; send.Q1_3=Q1; send.Q2_3=Q2; send.Ts3=Ts; send.sugarakAranya3=sarany; send.qSav3=qsav;
	break;
	}
...
send.TsH3=ez[7];
send.TsL3=ez[8];
send.PwmFrekREgH3=ez[9];
send.PwmFrekRegL3=ez[10];
send.qSav3=ez[11];
send.sugarakAranya3=ez[12];
...
send.TsH1=ez[7];
send.TsL1=ez[8];
send.PwmFrekREgH1=ez[9];
send.PwmFrekRegL1=ez[10];
send.qSav1=ez[11];
send.sugarakAranya1=ez[12];
...
send.TsH2=ez[7];
send.TsL2=ez[8];
send.PwmFrekREgH2=ez[9];
send.PwmFrekRegL2=ez[10];
send.qSav2=ez[11];
send.sugarakAranya2=ez[12];

	xil_printf("TCP %d %d %d %d %d %d %d %d %d %d %d %d %d \n\r",ez[0],ez[1],ez[2],(s16)ez[3],(s16)ez[4],(s16)ez[5],ez[6],ez[7],(u16)ez[8],(u16)ez[9],(s16)ez[10],ez[11],ez[12]);
*/
	/* free the received pbuf */
	xil_printf("TCP 9 %d %d %d %d",ipMagId,speedref, posref, config);
	pbuf_free(p);

	return ERR_OK;
}
err_t accept_callback9(void *arg, struct tcp_pcb *newpcb, err_t err)
{
	static int connection = 1;

	/* set the receive callback for this connection */
	tcp_recv(newpcb, recv_callback9);
...
int start_application9()
{
	...
	/* specify callback to use for incoming connections */
	tcp_accept(pcb, accept_callback9);
