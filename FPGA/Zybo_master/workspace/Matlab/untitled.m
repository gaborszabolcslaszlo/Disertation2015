...
function DutyPWMcoolers_Callback(hObject, eventdata, handles)
...
% --- Executes on selection change in PWMcoolers.
function PWMcoolers_Callback(hObject, eventdata, handles)
