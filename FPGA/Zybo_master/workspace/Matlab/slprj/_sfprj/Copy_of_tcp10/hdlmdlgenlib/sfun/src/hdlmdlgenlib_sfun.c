  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"hdlmdlgenlib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(429997205U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1119586594U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(256033993U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2721737113U);
        } else if (nrhs==4) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(tpChksum, "7dxDWY8llC1OzgDPO1dihH") == 0) {
