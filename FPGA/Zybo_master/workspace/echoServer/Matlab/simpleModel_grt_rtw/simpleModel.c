...
/* Real-time model */
RT_MODEL_simpleModel_T simpleModel_M_;
...
RT_MODEL_simpleModel_T *simpleModel(void)
{
  /* Registration code */
  ...
  /* External mode info */
  simpleModel_M->Sizes.checksums[0] = (151463243U);
  simpleModel_M->Sizes.checksums[1] = (3937036913U);
  simpleModel_M->Sizes.checksums[2] = (2875553461U);
  simpleModel_M->Sizes.checksums[3] = (3196771875U);
  ...
  (void) memset(((void *) &simpleModel_B), 0,
                sizeof(B_simpleModel_T));

  /* parameters */
  simpleModel_M->ModelData.defaultParam = ((real_T *)&simpleModel_P);

  /* states (dwork) */
  simpleModel_M->ModelData.dwork = ((void *) &simpleModel_DW);
  (void) memset((void *)&simpleModel_DW, 0,
                sizeof(DW_simpleModel_T));
