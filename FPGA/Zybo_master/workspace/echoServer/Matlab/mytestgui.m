...
% Last Modified by GUIDE v2.5 21-Apr-2015 18:29:36
...
% --- Executes on key press with focus on pushbuttonstop and none of its controls.
function pushbuttonstop_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to pushbuttonstop (see GCBO)
