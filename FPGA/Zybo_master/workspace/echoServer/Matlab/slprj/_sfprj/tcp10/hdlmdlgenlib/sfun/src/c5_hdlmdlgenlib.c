  ...
  *chartInstance)
{
  ...
  uint16_T *c5_u1;
  uint16_T *c5_u2;
  c5_u2 = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c5_y = (uint32_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_u1 = (uint16_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = sf_get_time(chartInstance->S);
  *c5_y = (uint32_T)*c5_u1 << 16 | (uint32_T)*c5_u2;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3098109069U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1151323106U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1375536145U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3783852763U);
}
...
static void mdlSetWorkWidths_c5_hdlmdlgenlib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(702052414U));
  ssSetChecksum1(S,(269586208U));
  ssSetChecksum2(S,(1221302536U));
  ssSetChecksum3(S,(1600619427U));
